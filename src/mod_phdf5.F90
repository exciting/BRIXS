...
!-----------------------------------------------------------------------------
  subroutine phdf5_write_z(val,dims,dimsg,offset,dataset_id)
    ...
    offset_(1)=0
    offset_(2:)=offset(:)
    ! write to hdf5 (reinterpret complex(8) as a pair of real(8))
    val_=transfer(val,val_)
    call phdf5_write_array_d(val_,ndims_,dims_,dimsg_,offset_,dataset_id)
    !deallocate arrays
    deallocate(dims_,dimsg_,offset_)
  end subroutine
...
!-----------------------------------------------------------------------------
  subroutine phdf5_read_d(val,dims,dimsg,offset,dataset_id)
    ...
    offset_(:)=offset(:)
    ! write to hdf5
    call phdf5_read_array_d(val_,ndims_,dims_,dimsg_,offset_,dataset_id)
    val=val_(1)
    !deallocate arrays
    deallocate(dims_,dimsg_,offset_)
  end subroutine
...
!-----------------------------------------------------------------------------
  subroutine phdf5_read_i(val,dims,dimsg,offset,dataset_id)
    ...
    offset_(:)=offset(:)
    ! write to hdf5
    call phdf5_read_array_i(val_,ndims_,dims_,dimsg_,offset_,dataset_id)
    val=val_(1)
    !deallocate arrays
    deallocate(dims_,dimsg_,offset_)
  end subroutine
!-----------------------------------------------------------------------------
  subroutine phdf5_read_z(val,dims,dimsg,offset,dataset_id)
    ...
    offset_(1)=0
    offset_(2:)=offset(:)
    ! read from hdf5, then reinterpret the real(8) pair as complex(8)
    call phdf5_read_array_d(val_,ndims_,dims_,dimsg_,offset_,dataset_id)
    val=transfer(val_,val)
    !deallocate arrays
    deallocate(dims_,dimsg_,offset_)
  end subroutine
